        ...
        return (
            ...
            <div className={styles.details}>
                <div className={styles.block}>
                    <img src={`data:;base64,${this.state.image}`} alt='avatar'></img>
                    <Link to="/uploadIcon">Змінити</Link>
                </div>
                <div className={styles.block}>
            ...
            <div className={styles.contacts}>
                ...
                <div className={styles.block}>
                    <Link to="/changeUserPhone">Змінити</Link>
                    <Link to="/changeUserEmail">Змінити</Link>
                </div>
            </div>
